...
pub const TestAllTypesProto3 = struct {
    ...
    map_int32_int32: std.ArrayList(TestAllTypesProto3.MapInt32Int32Entry) = .empty,
    map_int64_int64: std.ArrayList(TestAllTypesProto3.MapInt64Int64Entry) = .empty,
    map_uint32_uint32: std.ArrayList(TestAllTypesProto3.MapUint32Uint32Entry) = .empty,
    map_uint64_uint64: std.ArrayList(TestAllTypesProto3.MapUint64Uint64Entry) = .empty,
    map_sint32_sint32: std.ArrayList(TestAllTypesProto3.MapSint32Sint32Entry) = .empty,
    map_sint64_sint64: std.ArrayList(TestAllTypesProto3.MapSint64Sint64Entry) = .empty,
    map_fixed32_fixed32: std.ArrayList(TestAllTypesProto3.MapFixed32Fixed32Entry) = .empty,
    map_fixed64_fixed64: std.ArrayList(TestAllTypesProto3.MapFixed64Fixed64Entry) = .empty,
    map_sfixed32_sfixed32: std.ArrayList(TestAllTypesProto3.MapSfixed32Sfixed32Entry) = .empty,
    map_sfixed64_sfixed64: std.ArrayList(TestAllTypesProto3.MapSfixed64Sfixed64Entry) = .empty,
    map_int32_float: std.ArrayList(TestAllTypesProto3.MapInt32FloatEntry) = .empty,
    map_int32_double: std.ArrayList(TestAllTypesProto3.MapInt32DoubleEntry) = .empty,
    map_bool_bool: std.ArrayList(TestAllTypesProto3.MapBoolBoolEntry) = .empty,
    map_string_string: std.ArrayList(TestAllTypesProto3.MapStringStringEntry) = .empty,
    map_string_bytes: std.ArrayList(TestAllTypesProto3.MapStringBytesEntry) = .empty,
    map_string_nested_message: std.ArrayList(TestAllTypesProto3.MapStringNestedMessageEntry) = .empty,
    map_string_foreign_message: std.ArrayList(TestAllTypesProto3.MapStringForeignMessageEntry) = .empty,
    map_string_nested_enum: std.ArrayList(TestAllTypesProto3.MapStringNestedEnumEntry) = .empty,
    map_string_foreign_enum: std.ArrayList(TestAllTypesProto3.MapStringForeignEnumEntry) = .empty,
    ...
    repeated_bool_wrapper: std.ArrayList(google_protobuf.BoolValue) = .empty,
    repeated_int32_wrapper: std.ArrayList(google_protobuf.Int32Value) = .empty,
    repeated_int64_wrapper: std.ArrayList(google_protobuf.Int64Value) = .empty,
    repeated_uint32_wrapper: std.ArrayList(google_protobuf.UInt32Value) = .empty,
    repeated_uint64_wrapper: std.ArrayList(google_protobuf.UInt64Value) = .empty,
    repeated_float_wrapper: std.ArrayList(google_protobuf.FloatValue) = .empty,
    repeated_double_wrapper: std.ArrayList(google_protobuf.DoubleValue) = .empty,
    repeated_string_wrapper: std.ArrayList(google_protobuf.StringValue) = .empty,
    repeated_bytes_wrapper: std.ArrayList(google_protobuf.BytesValue) = .empty,
    ...
    repeated_struct: std.ArrayList(google_protobuf.Struct) = .empty,
